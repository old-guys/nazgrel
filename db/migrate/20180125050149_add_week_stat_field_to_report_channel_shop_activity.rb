class AddWeekStatFieldToReportChannelShopActivity < ActiveRecord::Migration[5.1]
  def change
    ...
    add_column :report_channel_shop_activities, :week_sale_order_amount, :decimal, precision: 11, scale: 3, default: 0, before: :month_sale_order_amount, comment: "本周店主订单金额"
