module Api::OpenMobile::Rescueable
  ...
  def invalid_app_error(e)
    ...
    render json: { code: ErrorCodes::INVALID_APP, message: e.message, remark: e.message, error: e.class.name.underscore }
  end

  def user_authentication_error(e)
    log_error(e)
    render json: { code: ErrorCodes::INVALID_USER, message: e.message, remark: e.message, error: e.class.name.underscore }
  end
  ...
  def auth_error(e)
    log_error(e)
    render json: { code: ErrorCodes::FAIL_AUTH, message: e.message, remark: e.message, error: e.class.name.underscore }
  end

  def auth_lock_error(e)
    log_error(e)
    render json: { code: ErrorCodes::AUTH_LOCK, message: e.message, remark: e.message, error: e.class.name.underscore }
  end

  def unauthorized_error(e)
    log_error(e)
    render json: { code: ErrorCodes::UNAUTHORIZED, message: e.message, remark: e.message, error: e.class.name.underscore }
  end
