module ChannelUserStatusable
  ...
  def invite_children_reward_amount
    if region_manager?
      return channel_region.channels.map(&:invite_children_reward_amount).sum
    end
  ...
  def children_comission_amount
    if region_manager?
      return channel_region.channels.map(&:children_comission_amount).sum
    end
  ...
  def invite_children_amount
    if region_manager?
      return channel_region.channels.map(&:invite_children_amount).sum
    end
  ...
  def indirectly_descendant_amount
    if region_manager?
      return channel_region.channels.map(&:indirectly_descendant_amount).sum
    end
